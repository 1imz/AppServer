...
app.post('/uploadData',function(req,res){
	...
	pool.connect(function(err,client,done) {
		...
		var querystring = "INSERT into formdata (name,surname,module,question,answerlist,geom) values ('";
		querystring = querystring + req.body.name + "','" + req.body.surname + "','" + req.body.module + "','";
		querystring = querystring + req.body.question + "','" + req.body.answerlist + "','" +geometrystring + "))";
		console.log(querystring);
		client.query( querystring,function(err,result) {
		done();
		if(err){
